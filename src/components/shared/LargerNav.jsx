...
const NavLink = ({ path, index }) => {
  ...
  return (
    <div key={index} className={`transition-all duration-300 relative inline-block  ${path === "SERVICES" && "group"}`}>
      ...
      >
        <span className="bigMon:text-[20px] 2xl:text-[17px] lg:text-[14px] relative group-hover:after:content-[''] group-hover:after:bg-[#00A88E] group-hover:after:h-[3px] after:w-[0%] group-hover:after:left-0 group-hover:after:-bottom-[5px] group-hover:after:rounded-xl group-hover:after:absolute group-hover:after:w-[100%] group-hover:after:duration-300">{path}</span>
