...
const CommonArrowBtn = ({ children }) => {
  return (
    <button className="btn rounded-[12px] border border-[#0060AF] w-[100%] py-[14px] transition-all duration-300 flex items-center justify-center overflow-hidden hover:border-[#0060AF] hover:bg-[#0060AF] hover:text-white group font-semibold text-[#0060AF] mt-[24px]">
