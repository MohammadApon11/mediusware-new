...
import bg from "../../../assets/commonHero/web.png";
...
const ServicesHero = ({ data }) => {
  ...
  return (
    <div
      className="relative h-[600px] bg-cover bg-center w-[100%] bg-fixed"
      style={{
    ...
    >
      ...
      <div className="absolute top-1/4 left-1/4 z-10 text-white text-center">
        ...
        <PrimaryBtn bg={true}>Read More</PrimaryBtn>
      </div>
    </div>
  );
};
